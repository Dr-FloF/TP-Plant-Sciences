...
write_compendium_description(package = "Model of root development and P uptake", 
                             description = "Pedagogic model for root development and P uptake simulation")
# to write a description, with dependencies listed 
# It's good practice to now go fill in the placeholder text.

write_dockerfile(maintainer = "Florian Fort") 
